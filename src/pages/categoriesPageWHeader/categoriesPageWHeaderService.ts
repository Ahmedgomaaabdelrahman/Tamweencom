...
@Injectable()
export class categoriesPageWHeaderService {
  ...
  constructor(private cache: CacheService,public _http: Http, public globalService:globalService) {
  }
  getCategoryRestful(): any {
    if(this.globalService.language == "en"){
